...
<script>
    ...
    export default{
        ...
        methods:{
            initChart:function(){
                let saleChart = echarts.init(document.getElementById('allSalePie'),'macarons');
                saleChart.setOption(this.salesMonStatus);
            },
            getData:function(){
                let root=this;
                root.$http.post('/api/statistics/getAllSaleData', new URLSearchParams(), {
                    headers: {
